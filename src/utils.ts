...
export const OrangeButtonClassName =
  "text-gray-100 bg-gradient-to-b from-[#ea5920f8] to-[#f37b26f7] before:bg-gradient-to-r before:from-[#eb6d13] before:to-[#eb991d] before:border-l-[1px] before:border-l-[#fff4] before:border-b-[1px] before:border-b-[#fff4] before:border-t-solid before:border-t-[1px] before:border-t-[#fff4]";
